...
export default function Bill({ onClose, bookingData, userName }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="relative max-w-4xl mx-auto">
                {emailStatus && (
                    <div className={`absolute -top-12 left-0 right-0 text-center p-2 rounded ${emailStatus === "success" ? "bg-green-500" : "bg-red-500"} text-white`}>
